...
function usage() {
  console.log(`Usage: node scripts/show-events.js [--json|--csv] [--limit N] [--addr 0x..]

Examples:
  node scripts/show-events.js             # pretty table (limit 50)
  node scripts/show-events.js --limit 100 # last 100 rows
  node scripts/show-events.js --json      # output JSON
  node scripts/show-events.js --csv       # output CSV
  node scripts/show-events.js --addr 0x123... # filter by user address
`);
}
